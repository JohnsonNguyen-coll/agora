...
export function ResultsView() {
  ...
  return <div className="page results-page"><Link to={'/rooms/' + room.id} className="back-link">← Back to the room</Link>
    ...
    <p className="result-topic">{room.topic}</p><VoteBar room={room} />
    <div className="form-actions"><Button onClick={() => exportTranscript(room)} disabled={!room.transcript.length}>Export transcript</Button><Link to="/">Back to the floor →</Link></div>
  </div>;
}
